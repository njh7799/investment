...
MODEL_SPECS: dict[str, ModelSpec] = {
    ...
    "absolute_momentum_12m": ModelSpec("12-month absolute momentum 0% adaptation", "momentum", "https://papers.ssrn.com/sol3/papers.cfm?abstract_id=2244633", "QQQ", "month-end 12-month return > 0", "TQQQ long/cash adaptation; not Antonacci Parity; cash return fixed at 0"),
