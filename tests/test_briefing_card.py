...
def test_all_card_states_share_one_allocation_layout(tmp_path: Path, monkeypatch):
    ...
    states = {
        "low": briefing(volatility=0.246, stock_weight=1.0, previous_stock_weight=1.0),
        "high": briefing(volatility=0.952, stock_weight=0.0, previous_stock_weight=0.0),
        "trade": briefing(volatility=0.246, stock_weight=1.0, previous_stock_weight=0.5),
    }
